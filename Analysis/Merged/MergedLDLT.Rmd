...
ggsurv1$plot <- ggsurv1$plot+ 
              ggplot2::annotate("text", 
                                ...
                                label = "Adjusted HR (ref: US, Canada HR 0.53, 95% CI 0.25-1.14, UK HR 0.32, 95% CI 0.71-2.53)", size = 6) 
ggsurv1
...
```{r Supplementary table 1 Canada}
#Uni
